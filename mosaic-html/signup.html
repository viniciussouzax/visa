                    ...
                    <div class="max-w-sm mx-auto w-full px-4 py-8">
                        ...
                        <form>
                            ...
                            <div class="flex items-center justify-between mt-6">
                                ...
                                <a class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-3 whitespace-nowrap" href="index.html">Sign Up</a>
                            </div>
                        </form>
                        <!-- Footer -->
                        <div class="pt-5 mt-6 border-t border-gray-100 dark:border-gray-700/60">
                            <div class="text-sm">
                                Have an account? <a class="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="signin.html">Sign In</a>
                            </div>
                        </div>
