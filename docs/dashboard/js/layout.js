...
const CURRENT_PAGE = (() => {
    ...
    if (path.includes('applicant')) return 'pipeline'; // applicant detail = pipeline sub-page
    return 'pipeline';
})();
