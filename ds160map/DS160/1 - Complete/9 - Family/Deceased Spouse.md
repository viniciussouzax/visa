...
<table cellspacing="0" border="0" id="ctl00_SiteContentPlaceHolder_FormView1" style="border-collapse:collapse;">
	<tbody><tr>
		<td colspan="2">
        <h2>
            <span class="tooltip_text" onmousemove="widetip=false; tip='Informacao de familia: conjuge falecido'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                
                <span id="ctl00_SiteContentPlaceHolder_FormView1_lblPreviousSpouse">Family Information: Deceased Spouse</span>
            </span>
        </h2>
        ...
        <br>
                            ...
                            <div class="field-group">
                                <div class="field full">
                                    <span class="tooltip_text" onmousemove="widetip=false; tip='Nomes de Família (Pt); Sobrenomes (Br)'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                                        <label for="ctl00_SiteContentPlaceHolder_FormView1_tbxSURNAME" id="ctl00_SiteContentPlaceHolder_FormView1_lblSURNAME">Surname</label></span>
                                    ...
                                    <br>  
                                    <input name="ctl00$SiteContentPlaceHolder$FormView1$tbxSURNAME" type="text" maxlength="33" id="ctl00_SiteContentPlaceHolder_FormView1_tbxSURNAME" tabindex="210" onchange="javascript:setDirty();" style="width: 95%">
                                    <br>
                                    <br>
                                    <span class="tooltip_text" onmousemove="widetip=false; tip='Nomes próprios (Pt) / Nomes (Br)'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                                        <label for="ctl00_SiteContentPlaceHolder_FormView1_tbxGIVEN_NAME" id="ctl00_SiteContentPlaceHolder_FormView1_lblGIVEN_NAME">Given Name</label>
                                    </span>
                                    ...
                                    <br>
                                    <input name="ctl00$SiteContentPlaceHolder$FormView1$tbxGIVEN_NAME" type="text" maxlength="33" id="ctl00_SiteContentPlaceHolder_FormView1_tbxGIVEN_NAME" tabindex="211" onchange="javascript:setDirty();" style="width: 95%">
                                </div>                                        
                                <div class="field full">
                                
                                    <span class="tooltip_text" onmousemove="widetip=false; tip='Data de Nascimento'; delayToolTip(event,tip,widetip,40,0);return false" onmouseout="hideToolTip()">
                                        <span id="ctl00_SiteContentPlaceHolder_FormView1_lblSpouseDOB">Date of Birth</span>
                                    </span>
                                    ...
                                    <div class="date">
                                        ...
                                        <select name="ctl00$SiteContentPlaceHolder$FormView1$ddlDOBDay" id="ctl00_SiteContentPlaceHolder_FormView1_ddlDOBDay" tabindex="400" onchange="javascript:setDirty();" style="width:45px;">
			...
			<option value="31">31</option>
                                        ...
                                        <select name="ctl00$SiteContentPlaceHolder$FormView1$ddlDOBMonth" id="ctl00_SiteContentPlaceHolder_FormView1_ddlDOBMonth" tabindex="410" onchange="javascript:setDirty();" style="width:55px;">
			<option selected="selected" value="   "></option>
			...
			<option value="DEC">DEC</option>
                                        ...
                                        <input name="ctl00$SiteContentPlaceHolder$FormView1$tbxDOBYear" type="text" maxlength="4" id="ctl00_SiteContentPlaceHolder_FormView1_tbxDOBYear" tabindex="420" onchange="javascript:setDirty();" style="width:35px;">
                                        <div class="hint">
                                ...
                                <div id="ctl00_SiteContentPlaceHolder_FormView1_PobAndNatl" class="field-groups">                                                                                                            
                                    <div class="field full">
                                        <span class="tooltip_text" onmousemove="widetip=false; tip='Nacionalidade'; delayToolTip(event,tip,widetip,0,-10);return false" onmouseout="hideToolTip()">
                                            <span id="ctl00_SiteContentPlaceHolder_FormView1_SpouseNatLabel">Country/Region of Origin (Nationality)</span>
                                        </span>
                                        <span id="ctl00_SiteContentPlaceHolder_FormView1_csvddlSpouseNatDropDownList" style="color:Red;visibility:hidden;"> <img alt="Error" src="../../_res/img/trg_bk.GIF"></span>
                                        <select name="ctl00$SiteContentPlaceHolder$FormView1$ddlSpouseNatDropDownList" id="ctl00_SiteContentPlaceHolder_FormView1_ddlSpouseNatDropDownList" tabindex="501" onchange="javascript:setDirty();" style="width: 99%" data-gtm-form-interact-field-id="1">
			...
			<option value="ZIMB">ZIMBABWE</option>
                                    ...
                                    <div class="infoDiv">
                                        <h4>
                                            <span class="tooltip_text" onmousemove="widetip=false; tip='Lugar de nascimento do conjuge falecido'; delayToolTip(event,tip,widetip,0,20);return false" onmouseout="hideToolTip()">
                                                <span id="ctl00_SiteContentPlaceHolder_FormView1_lblSpousePOBInfo">Deceased Spouse's Place of Birth</span>
                                            </span>
                                        </h4>
                                        <div class="field-group callout">
                                            <div class="field full">
                                                <span class="tooltip_text" onmousemove="widetip=false; tip='Cidade'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                                                    <span id="ctl00_SiteContentPlaceHolder_FormView1_lblSpousePOBCity">City</span>
                                                </span>
                                                <span id="ctl00_SiteContentPlaceHolder_FormView1_csvtbxSpousePOBCity" style="color:Red;visibility:hidden;"> <img alt="Error" src="../../_res/img/trg_bk.GIF"></span>
                                                <br>
                                                <input name="ctl00$SiteContentPlaceHolder$FormView1$tbxSpousePOBCity" type="text" maxlength="20" id="ctl00_SiteContentPlaceHolder_FormView1_tbxSpousePOBCity" tabindex="501" onchange="javascript:setDirty();" style="width: 99%">
                                                <div class="field full" style="text-align: right; padding-bottom: 0px">
                                                    <input name="ctl00$SiteContentPlaceHolder$FormView1$tbxSpousePOBCity_NA" type="hidden" id="ctl00_SiteContentPlaceHolder_FormView1_tbxSpousePOBCity_NA">
                                                    <span class="RadioCheck"><span class="tooltip_text" onmousemove="widetip=false; tip='Desconheço'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                                                        <input id="ctl00_SiteContentPlaceHolder_FormView1_cbxSPOUSE_POB_CITY_NA" type="checkbox" name="ctl00$SiteContentPlaceHolder$FormView1$cbxSPOUSE_POB_CITY_NA" onclick="javascript:setDirty();setTimeout('__doPostBack(\'ctl00$SiteContentPlaceHolder$FormView1$cbxSPOUSE_POB_CITY_NA\',\'\')', 0)" tabindex="560"><label for="ctl00_SiteContentPlaceHolder_FormView1_cbxSPOUSE_POB_CITY_NA">Do Not Know</label></span>
                                                    </span>
                                                </div>
                                            </div>     
                                            <div class="field full">
                                                <span class="tooltip_text" onmousemove="widetip=false; tip='País/Região'; delayToolTip(event,tip,widetip,0,0);return false" onmouseout="hideToolTip()">
                                                    <span id="ctl00_SiteContentPlaceHolder_FormView1_tbxSpousePOBCountry">Country/Region</span>
                                                </span>
                                                <span id="ctl00_SiteContentPlaceHolder_FormView1_csvddlSpousePOBCountry" style="color:Red;visibility:hidden;"> <img alt="Error" src="../../_res/img/trg_bk.GIF"></span>
                                                <select name="ctl00$SiteContentPlaceHolder$FormView1$ddlSpousePOBCountry" id="ctl00_SiteContentPlaceHolder_FormView1_ddlSpousePOBCountry" tabindex="570" onchange="javascript:setDirty();" style="width:325px;" data-gtm-form-interact-field-id="0">
			<option selected="selected" value="">- Select One -</option>
			<option value="AFGH">AFGHANISTAN</option>
			<option value="ALB">ALBANIA</option>
			<option value="ALGR">ALGERIA</option>
...
<div class="fieldset-group">
    <fieldset class="submits">
        <div>
            <span class="tooltip_text" onmouseover="widetip=false; tip='Voltar'; delayToolTip(event,tip,widetip,0,-30);return false" onmouseout="hideToolTip()">
            <input type="submit" name="ctl00$SiteContentPlaceHolder$UpdateButton1" value="Back: Relatives" onclick="javascript:needToConfirm = false;WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$SiteContentPlaceHolder$UpdateButton1&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="ctl00_SiteContentPlaceHolder_UpdateButton1" tabindex="5000" class="back" onfocus="return ValidNavigation();">
           </span>
           <span class="tooltip_text" onmouseover="widetip=false; tip='Guardar (Pt) / Salvar (Br)'; delayToolTip(event,tip,widetip,0,-30);return false" onmouseout="hideToolTip()">
           ...
           <span class="tooltip_text" onmouseover="widetip=false; tip='Próximo'; delayToolTip(event,tip,widetip,0,-30);return false" onmouseout="hideToolTip()">
                <input type="submit" name="ctl00$SiteContentPlaceHolder$UpdateButton3" value="Next: Work/Education/Training" onclick="javascript:needToConfirm = false;WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$SiteContentPlaceHolder$UpdateButton3&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="ctl00_SiteContentPlaceHolder_UpdateButton3" accesskey="z" tabindex="5020" class="next" onfocus="return ValidNavigation();">
           </span>
        </div>
    </fieldset>
</div>
